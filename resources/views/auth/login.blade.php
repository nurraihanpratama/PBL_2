...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('assets') }}/img/lph-img.png" />
        ...
        <div class="container">
            <div class="card login-card">
                <div class="row no-gutters">
                    <div class="col-md-5">
                        <img src="{{ asset('assets') }}/img/lph-img.png" alt="login" class="login-card-img">
                    </div>
                    <div class="col-md-7">
                        <div class="card-body">
                            <div class="brand-wrapper">
                                <img src="{{ asset('assets') }}/img/lph-logo.png" alt="logo" class="logo">
                            </div>
